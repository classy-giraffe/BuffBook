...
const SECURITY_HEADERS: Record<string, string> = {
  ...
  "Content-Security-Policy": [
    "default-src 'self'",
    "script-src 'self' 'unsafe-inline' blob: https://www.googletagmanager.com https://js.stripe.com",
    "style-src 'self' 'unsafe-inline'",
    "img-src 'self' data: blob:",
    "font-src 'self'",
    "frame-src 'self' blob: https://js.stripe.com",
    "worker-src 'self' blob:",
    "connect-src 'self' https://www.googletagmanager.com https://www.google-analytics.com https://*.stripe.com",
