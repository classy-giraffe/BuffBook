...
Full ROM training should be the default for most exercises in most [mesocycles](/chapter6/mesocycle). It provides tension across the entire contractile range, trains the muscle at both long and short lengths, and builds mobility alongside strength.
