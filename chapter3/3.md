...
- **Fiber-specific:** muscles do not grow as uniform blocks, instead, different fiber located in different regions of the muscle may grow more or less depending on the exercise selection and how the load is applied.
