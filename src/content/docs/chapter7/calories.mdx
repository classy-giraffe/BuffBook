...
The energy content of food comes from three [macronutrients](/chapter7/macronutrients), each with a different caloric density (known as the **Atwater factors**):

| Macronutrient | Energy per gram |
|:---|:---:|
| **[Protein](/chapter7/protein)** | 4 kcal/g |
