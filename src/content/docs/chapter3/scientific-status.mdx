...
*   **[Fiber Type](/chapter3/fiber-types) Gradients:** Some regions of a muscle may simply have more growth-prone Type II fibers than others.
...
Part of the confusion in this field comes from a lack of agreed-upon definitions. Some researchers use "SMH" only to refer to growth from passive tension, while others use it to describe *any* growth that happens because you trained at a long muscle length [14]. 
