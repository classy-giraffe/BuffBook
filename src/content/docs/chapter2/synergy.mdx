---
title: 2.1.6 The Non-Negotiable Synergy
---

import Callout from '@components/callouts/Callout.astro';

![High MUR and High Tension Synergy](/chapter2/images/high_mur_and_tension.png)

The central argument of this book is that hypertrophy requires the simultaneous presence of: 
- High [motor unit](/chapter2/motor-units) recruitment 
- High fiber-level [mechanical tension](/chapter2/mechanical-tension). 
