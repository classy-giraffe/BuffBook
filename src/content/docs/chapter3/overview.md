...
In this chapter we will also try to address the question of whether the different type of fibers (Type I vs. Type II) respond differently to different training methods, and whether there are any practical implications for how we should structure our training to maximize growth across all [fiber types](/chapter3/fiber-types).
